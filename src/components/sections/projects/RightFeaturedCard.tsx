...
interface RightFeaturedCardProps {
  project: Project;
}

const RightFeaturedCard: FunctionComponent<RightFeaturedCardProps> = (
  props
) => {
  return (
    <div className="inline-flex w-full justify-center align-middle">
      <div className="type z-50 -mr-24 mt-4 flex flex-col dark:type-invert">
        ...
        <div className="relative z-0 h-48 w-full rounded-md border border-light-bg/30 bg-gradient-to-br from-light-bg/80 to-transparent p-4 backdrop-blur-lg dark:from-dark-primary/80">
          <h6 className="m-1 text-left font-medium text-blue-md dark:text-green">
            Featured project
          </h6>
          <p>
...
export default RightFeaturedCard;
